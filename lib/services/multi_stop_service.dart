...
class MultiStopService {
  ...
  // Mapbox API credentials from environment
  String get _mapboxAccessToken => EnvConfig.mapboxAccessToken;
  String get _mapboxSecretToken => EnvConfig.mapboxSecretToken;
  ...
  Future<Map<String, dynamic>> optimizeRoute({
    ...
    try {
      ...
      final url = Uri.parse(
        ...
        '?access_token=$_mapboxSecretToken' // Use secret token for server-side API
